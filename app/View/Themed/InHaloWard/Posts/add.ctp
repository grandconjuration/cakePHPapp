...
<?php
	...
	echo $this->Form->input('body', array('error' => false, 'rows' => '3', 'label' => 'Inhoud', 'class' => 'tinymce', 'before' => '<tr><td colspan="2">', 'between' => '</td></tr><tr><td colspan="2">', 'after' => '</td></tr>', 'div' => false));
